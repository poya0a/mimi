(($)=>{
  ...
  class Mimi {
    ...
    header(){
      ...
      function loginEvent(){
        ...
        if( result === localData.세션 ){
          $('.login-btn, .member-btn').hide();
          $('.modify-btn, .logout-btn').show();
      ...
      $('.logout-btn').on({
        ...
        $('.modify-btn, .logout-btn').hide();
        $('.login-btn, .member-btn').show();
        $('.modify-btn').text('');
    ...
    section1(){
      ...
      function mainSlide(){
        $('#section1 .slide-wrap').stop().animate({left:-winW*cnt},800,'easeOutExpo',()=>{
          cnt>9?cnt=0:cnt;
          cnt<0?cnt=9:cnt;
      ...
      function pausefn(){
        ...
        $('#section1 .pause-btn').children().attr('class','fa fa-play');
      ...
      function playfn(){
        autoTimer();
        $('#section1 .pause-btn').children().attr('class','fa fa-pause');
      }
      ...
      //페이지 버튼 이벤트
      $('#section1 .page-btn').each((index)=>{
        $('#section1 .page-btn').eq(index).click((e)=>{
          e.preventDefault();
          if(!$('#section1 .slide-wrap').is(':animated')){
            cnt=index;
            mainSlide();
    ...
    section3(){
      ...
      $(window).scroll(()=>{
        ...
        if($(window).scrollTop()>sec3Top){
          $('#section3 h2').addClass('sec3ani');
          return;
        }
        if($(window).scrollTop()===0){
          $('#section3 h2').removeClass('sec3ani');
          return;
        }
      });
      ...
      function sec3Slide(){
        ...
        $('#section3 .slide-wrap').stop().animate({left:-slideW*cnt},800,()=>{
          cnt>9?cnt=0:cnt;
          cnt<0?cnt=9:cnt;
      ...
      function pausefn(){
        ...
        $('#section3 .sec3-pause-btn').children().attr('class','fa fa-play');
      ...
      function playfn(){
        autoTimer();
        $('#section3 .sec3-pause-btn').children().attr('class','fa fa-pause');
      }

      //정시/재생 버튼 이벤트
      $('#section3 .sec3-pause-btn').on({
        click:function(e){
          e.preventDefault();
          if($(this).children().hasClass('fa-pause')){
            pausefn();
      ...
      $('#section3 .slide-view').on({
        mousedown:function(e){
          ...
          touchStart=e.clientX;
          dragStart=e.clientX-$('#section3 .slide-wrap').offset().left-winW+(slideW/2);
          mouseDown=true;
      ...
      $('#section3 .slide-view').on({
        touchstart: function(e){
          ...
          touchStart=e.originalEvent.changedTouches[0].clientX;                        
          dragStart=e.originalEvent.changedTouches[0].clientX-$('#section3 .slide-wrap').offset().left-winW+(slideW/2);
          mouseDown=true;
        },
    ...
    section5(){
      ...
      $('#section5 .sec5-btn').each((index)=>{
        $('#section5 .sec5-btn').eq(index).on({
            click: function(e){
              e.preventDefault();
               idx=index;
               galleryMain();
    ...
    section8(){
      ...
      console.log(slideWarpW, slideW);

      //슬라이드
      function sec8Slide(){
        slideW=slideWarpW/21;
        $('#section8 .slide-wrap').stop().animate({left:-slideW*cnt},600,()=>{
          cnt>10?cnt=0:cnt;
          cnt<0?cnt=10:cnt;
      ...
      $('#section8 .slide-view').on({
        ...
        mousedown:function(e){
          ...
          touchStart=e.clientX;
          dragStart=e.clientX-$('#section8 .slide-wrap').offset().left-(slideW*2+slideW/2);
          mouseDown=true;
      ...
      $('#section8 .slide-view').on({
        touchstart: function(e){
          ...
          touchStart=e.originalEvent.changedTouches[0].clientX;                        
          dragStart=e.originalEvent.changedTouches[0].clientX-$('#section8 .slide-wrap').offset().left-(slideW*2+slideW/2);
          mouseDown=true;
        },
    ...
    section10(){
      ...
      let emailVal='';
      let dateVal='';
      const regExpEmail=/^[A-Za-z]([-_\.]?[A-Za-z])*@[A-Za-z]([-_\.]?[A-Za-z])*\.[A-Za-z]{2,3}$/g;
      ...
      $('.submit-btn').on({
        click:function(e){
          ...
          nameVal=$('#name').val();
          emailVal=$('#email').val();
          dateVal=new Date().getFullYear()+'-'+(new Date().getMonth()+1)+'-'+new Date().getDate();
          ...
          if(regExpEmail.test(emailVal)!==true){
